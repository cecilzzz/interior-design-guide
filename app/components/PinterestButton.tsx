...
export default function PinterestButton({ 
  ...
  return (
    <button
      ...
      className={`absolute left-4 top-4 bg-red-600 text-white rounded-full p-1.5 transition-all duration-300 hover:bg-red-700 hover:scale-110 shadow-sm ${className}`}
