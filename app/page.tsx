...
const recommendedPosts = [
  ...
  },
  {
    ...
    coverImageUrl: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?auto=format&fit=crop&q=80&w=200",
    link: "/blog/modern-minimalism",
  },
  {
    title: "Color Psychology in Interior Design",
    coverImageUrl: "https://images.unsplash.com/photo-1618377385526-83312906f0dc?auto=format&fit=crop&q=80&w=200",
...
const relatedPosts = [
  ...
  },
  {
    ...
    coverImageUrl: "https://images.unsplash.com/photo-1616137466211-f939a420be84?auto=format&fit=crop&q=80&w=800",
    link: "/blog/small-space-solutions",
  },
  {
    category: "INSPIRATION",
    title: "Bringing Nature Indoors: Biophilic Design",
    coverImageUrl: "https://images.unsplash.com/photo-1617104666298-550277b2e27c?auto=format&fit=crop&q=80&w=800",
...
export default function Home() {
  const blogPost = {
    ...
    coverImageUrl: "https://images.unsplash.com/photo-1616137466211-f939a420be84?auto=format&fit=crop&q=80&w=1920",
    ...
    <div>
      ...
      <div className="max-w-[120rem] mx-auto px-4 sm:px-6 md:px-12 lg:px-24 pt-8">
        <HeroSection
          ...
          date="DECEMBER 2024"
          coverImageUrl="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=1920"
        />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-24 pt-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-12">
          <ArticleLayout currentArticle={blogPost} relatedArticles={relatedPosts} />
