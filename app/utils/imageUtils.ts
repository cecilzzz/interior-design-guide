...
const TRANSFORM_PARAMS = {
  // 博客主圖：大圖，高質量，固定比例，高密度螢幕支援
  hero: 'w_1920,h_1080,c_fill,q_auto:good,f_auto,dpr_auto',
  
  // 文章內容圖：適中寬度，保持原比例，高密度螢幕支援
  content: 'w_800,c_fit,q_auto,f_auto,dpr_auto',
  
  // 縮略圖：較小尺寸，用於文章卡片、側邊欄、相關文章等，高密度螢幕支援
  thumbnail: 'w_400,c_fit,q_auto,f_auto,dpr_auto',
 ...
 * → https://res.cloudinary.com/dwobltbzw/image/upload/w_1920,h_1080,c_fill,q_auto:good,f_auto,dpr_auto/posts/japanese-living-room/main.jpg
 * 
 * 文章內容圖:
 * getImageUrl('/posts/japanese-living-room/detail-1.jpg', 'content')
 * → https://res.cloudinary.com/dwobltbzw/image/upload/w_800,c_fit,q_auto,f_auto,dpr_auto/posts/japanese-living-room/detail-1.jpg
 * 
 * 縮略圖:
 * getImageUrl('/posts/japanese-living-room/thumb.jpg', 'thumbnail')
 * → https://res.cloudinary.com/dwobltbzw/image/upload/w_400,c_fit,q_auto,f_auto,dpr_auto/posts/japanese-living-room/thumb.jpg
 * 
 * Unsplash 圖片:
